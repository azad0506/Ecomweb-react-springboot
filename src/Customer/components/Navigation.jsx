...
// Search (MagnifyingGlassIcon): Clickable button.
// Cart (ShoppingBagIcon): Shows item count (currently 0).
                ...
                <div className="flex h-full space-x-8">
                  {navigation.categories.map((category) => (
                    <Popover key={category.name} className="flex">
                      {({ open, close }) => ( // Access `open` and `close`
                        <>
                                          ...
                                          {section.items.map((item) => (
                                            <li key={item.name} className="flex">
                                              <p
                                                ...
                                                onClick={() => handleCategoryClick(category, section, item, close)} // Pass `close`
                                              >
                                                {item.name}
                                              </p>
                                            </li>
