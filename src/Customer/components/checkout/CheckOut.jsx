...
export default function CheckOut() {
    ...
    console.log("stepFromQuery", stepFromQuery)


    const [activeStep, setActiveStep] = React.useState(isNaN(stepFromQuery) ? 1 : stepFromQuery);
    // const [completed, setCompleted] = React.useState({});
    const [completed, setCompleted] = React.useState({ 0: true }); // Login step already completed
                ...
                <div>
                    {allStepsCompleted() ? (
                        ...
                        <>
                            ...
                            {/* important */}
                            <div className='mt-10'>
                                {/* {activeStep === 0 && <LoginForm handleComplete={handleComplete}/> } */}
                                {stepFromQuery == 1 ? <DeliveryAddressForm handleComplete={handleComplete} /> : <OrderSummary  handleComplete={handleComplete}/>}
                            </div>
                        </>
                    )}
                </div>
